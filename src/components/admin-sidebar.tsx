...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/admin/operations', label: 'Operations Console', icon: Activity, section: 'operations' },
  { href: '/admin/shift-roster', label: 'Shift Roster', icon: Calendar, section: 'operations' },
  { href: '/admin/tasks', label: 'Staff Tasks', icon: List, section: 'operations' },
