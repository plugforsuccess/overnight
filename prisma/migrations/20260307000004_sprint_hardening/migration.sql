...
-- ============================================================
-- 0. Defensive: ensure 000003_operational_hardening tables exist
-- ============================================================
-- If 000003 partially failed but was marked as applied, Prisma will
-- not re-run it. These CREATE TABLE IF NOT EXISTS statements self-heal
-- without duplicating if 000003 already ran successfully.
...
-- RLS for 000003 tables (idempotent — ENABLE is safe to repeat)
